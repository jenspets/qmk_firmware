...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* Colemak
     * ,----------------------------------------------------------------------------------------------------------------.
     * | Tab        |     Q   |    W   |    F   |     P    |    B   |    J   |    L    |    U   |    Y   | RALT/; |  RAlt |
     * |------------+---------+--------+--------+----------+--------+--------+---------+--------+--------+--------+-------|
     * | Esc/Ctrl   | LGUI/A  | LALT/R | LCTL/S |  LSFT/T  | RALT/G | RALT/M |  RSFT/N | RCTL/E | LALT/I | LGUI/O |   '   |
     * |------------+---------+--------+--------+----------+--------+------+---------+--------+--------+--------+-------|
     * | Shift/Caps |  NAV/Z  |    X   |    C   |     D    |    V   |    K   |    H    |    ,   |    .   |  NUM// | Enter |
     * |------------+---------+--------+--------+----------+--------+--------+---------+--------+--------+--------+-------|
    ...
    /* Game
     * ,-----------------------------------------------------------------------------------------.
     * | Tab        |   Q  |   W  |   E  |   R  |     |   Y  |   U  |   I  |   O  |   P  | RAlt |
     * |------------+------+------+------+------+------+------+------+------+------+------+------|
     * | Esc/Ctrl   |   A  |   S  |   D  |   F  |     |   H  |   J  |   K  |   L  |   ;  |  '   |
     * |------------+------+------+------+------+------+------+------+------+------+------+------|
     * | Shift/Caps |   Z  |   X  |   C  |   V  |     |   N  |   M  |   ,  |   .  |   /  |Enter |
     * |------------+------+------+------+------+------+------+------+------+------+------+------|
     ...
     * `-----------------------------------------------------------------------------------------'
     */
    [_GAME2] = LAYOUT_ortho_4x12_wrap(GAME2_R2_L, KC_TAB, KC_RALT, GAME2_R2_R,
					GAME2_R3_L, LCTL_T(KC_ESC), KC_QUOT, GAME2_R3_R, 
					GAME2_R4_L, LSFT_T(KC_CAPS), KC_ENT, GAME2_R4_R,
					TG(_NAV), KC_LEFT, KC_RGHT, GAME2_T_L, KC_LGUI, KC_LALT, GAME2_T_R, KC_DOWN, KC_UP, TG(_NUM)),
