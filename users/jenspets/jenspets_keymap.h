...
#define ADJ_T_R  KC_TRNS, KC_TRNS
...
#define NAV_R4_L KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
#define NAV_R4_R KC_NO, KC_NO, KC_INS, KC_HOME, KC_PGUP
#define NAV_T_L  KC_TRNS, KC_SPC
#define NAV_T_R  KC_TRNS, TG(_NAV)

#define NUM_R2_L KC_NO, KC_HOME, KC_UP, KC_END, KC_PGUP
#define NUM_R2_R KC_NLCK, KC_PENT, KC_P7, KC_P8, KC_P9
#define NUM_R3_L KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN
#define NUM_R3_R KC_NO, KC_TAB, KC_P4, KC_P5, KC_P6
#define NUM_R4_L KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
#define NUM_R4_R KC_DEL, KC_PEQL, KC_P1, KC_P2, KC_P3
